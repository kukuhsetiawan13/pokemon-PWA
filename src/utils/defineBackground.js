...
export const defineLabelBackground = (arr) => {
    ...
    else if(arr.find(el => el.type?.name === 'electric')) return 'bg-yellow-label'
    else if(arr.find(el => el.type?.name === 'bug')) return 'bg-dark-green-label'
    else if(arr.find(el => el.type?.name === 'flying')) return 'bg-light-blue-label'
    else if(arr.find(el => el.type?.name === 'poison')) return 'bg-purple-label'
    else if(arr.find(el => el.type?.name === 'fairy')) return 'bg-pink-label'
    else if(arr.find(el => el.type?.name === 'ground')) return 'bg-brown-label'
    else if(arr.find(el => el.type?.name === 'rock')) return 'bg-maroon-label'
    else if(arr.find(el => el.type?.name === 'normal')) return 'bg-normal-label'
    else if(arr.find(el => el.type?.name === 'psychic')) return 'bg-light-pink-label'
    else if(arr.find(el => el.type?.name === 'fighting')) return 'bg-orange-label'
    else if(arr.find(el => el.type?.name === 'dark')) return 'bg-black-label'
    else if(arr.find(el => el.type?.name === 'ghost')) return 'bg-dark-purple-label'
    else if(arr.find(el => el.type?.name === 'steel')) return 'bg-cyan-label'
